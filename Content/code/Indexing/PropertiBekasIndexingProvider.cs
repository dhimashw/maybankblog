namespace Sitecore.Feature.Content.Indexing
{
    ...
    public class PropertiBekasIndexingProvider : ProviderBase, ISearchResultFormatter, IQueryPredicateProvider
    {
        ...
        public IEnumerable<ID> SupportedTemplates => new[] { Templates.PropertiBekas.ID };
