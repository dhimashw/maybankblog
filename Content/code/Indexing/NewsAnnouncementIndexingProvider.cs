namespace Sitecore.Feature.Content.Indexing
{
    ...
    public class NewsAnnouncementIndexingProvider : ProviderBase, ISearchResultFormatter, IQueryPredicateProvider
    {
        ...
        public string ContentType => DictionaryPhraseRepository.Current.Get("/Feature/Content/Article", "News Announcement");
        ...
        public void FormatResult(SearchResultItem item, ISearchResult formattedResult)
        {
            ...
            formattedResult.Title = FieldRenderer.Render(contentItem, Templates.Article.Fields.Title.ToString());
