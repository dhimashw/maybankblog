namespace Sitecore.Feature.Content.Indexing
{
    ...
    public class PromotionIndexingProvider : ProviderBase, ISearchResultFormatter, IQueryPredicateProvider
    {
        ...
        public string ContentType => DictionaryPhraseRepository.Current.Get("/Feature/Content/Article", "Promotion page");

        public IEnumerable<ID> SupportedTemplates => new[] { Templates.PromotionPageCreditCard.ID };
