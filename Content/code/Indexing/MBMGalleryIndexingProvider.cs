namespace Sitecore.Feature.Content.Indexing
{
    ...
    public class MBMGalleryIndexingProvider : ProviderBase, ISearchResultFormatter, IQueryPredicateProvider
    {
        ...
        public string ContentType => DictionaryPhraseRepository.Current.Get("/Feature/Content/MBMGallery", "MBM Gallery Photos");

        public IEnumerable<ID> SupportedTemplates => new[] { Sitecore.Feature.Library.Templates.MBMGalleryItem.ID};
