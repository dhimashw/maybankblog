<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApprovedComment.ascx.cs" Inherits="Sitecore.Feature.Administrators.Sitecore.Admin.UserControl.ApprovedComment" %>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="top-button" data-toggle="affix">
                <asp:Button runat="server" ID="BtnDelete" Text="Delete" OnClick="BtnDelete_Click" CssClass="btn btn-sm btn-delete"/>
            </div>
            <hr />
            <div class="row">
            ...
            <hr />
            <table id="dtApprovedComment" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-selectCheckbox="selectAllApprovedComment">
                <thead>
                    <tr>
                        <th class="th-sm">
                            <input type="checkbox" value="" id="selectAllApprovedComment">
                        </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center !important;">
                                    <%# (bool)DataBinder.Eval(Container.DataItem, "isApproved") == true ? "Approved" : "Rejected" %>
                                </td>
                                <%--<td style="text-align: center !important;">
