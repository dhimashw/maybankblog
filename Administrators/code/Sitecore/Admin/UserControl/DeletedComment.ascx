<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DeletedComment.ascx.cs" Inherits="Sitecore.Feature.Administrators.Sitecore.Admin.UserControl.DeletedComment" %>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="top-button" data-toggle="affix">
                <asp:Button runat="server" ID="BtnRestore" Text="Restore" OnClick="BtnRestore_Click" CssClass="btn btn-sm btn-restore"/>
            </div>
            <hr />
            <div class="row">
            ...
            <hr />
            <table id="dtApprovedComment" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" data-selectCheckbox="selectAllDeletedComment">
                <thead>
                    <tr>
                        <th class="th-sm">
                            <input type="checkbox" value="" id="selectAllDeletedComment">
                        </th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center !important;">
                                    <%# (bool)DataBinder.Eval(Container.DataItem, "isDelete") == true ? "Deleted" : "invalid_logic" %>
                                </td>
                                <%--<td style="text-align: center;"><%# DataBinder.Eval(Container.DataItem, "isApproved") %></td>--%>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
